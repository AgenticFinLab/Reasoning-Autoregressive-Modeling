"""EQD Hierarchical - DeepSpeed Training.
...
def train_eqd_hierarchical(config: dict, ds_config: dict, tee_logger: TeeLogger | None = None):
    ...
    if is_main_process:
        ...
        logger.log_header("EQD Hierarchical - DeepSpeed Training")
    else:
        logger = None
    ...
    eqd_model = EQDHierarchicalModel(model_cfg)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="EQD Hierarchical - DeepSpeed Training"
    )
    parser.add_argument(
        "--config",
        type=str,
