"""EQD Scales Reconstruction Evaluation Script.

Usage:
    python examples/eqd_scales/run_recon.py -c configs/eqd_scales/config.yaml
    python examples/eqd_scales/run_recon.py -c configs/eqd_scales/config.yaml -n 50

This script loads a trained EQD Scales model from checkpoints and generates
...
from model import EQDScalesModel
...
def run_reconstruction(
    ...
    Args:
        model: Trained EQD Scales model
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="EQD Scales Reconstruction Evaluation",
    )
    parser.add_argument(
        "-c",
        "--config",
