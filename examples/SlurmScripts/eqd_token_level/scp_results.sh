...
#
# Options:
#   -e  Experiment name (required): eqd_token_level, eqd_token_level_ds, etc.
...
#
# Examples:
#   ./scp_results.sh -e eqd_token_level -t all             # Download to ./EXPERIMENT/eqd_token_level/
#   ./scp_results.sh -e eqd_token_level_ds -t logs         # Download logs to ./EXPERIMENT/eqd_token_level_ds/
#   ./scp_results.sh -e eqd_token_level_ds -t all -p ./results
# =============================================================================
...
while getopts "e:t:p:h" opt; do
    case $opt in
        ...
        h)
            ...
            echo ""
            echo "Options:"
            echo "  -e  Experiment name (required): eqd_token_level, eqd_token_level_ds, etc."
            ...
            echo ""
            echo "Examples:"
            echo "  $0 -e eqd_token_level -t all"
            echo "  $0 -e eqd_token_level_ds -t logs"
            echo "  $0 -e eqd_token_level_ds -t checkpoints"
            exit 0
            ;;
        \?)
