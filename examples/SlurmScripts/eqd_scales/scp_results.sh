...
#
# Options:
#   -e  Experiment name (required): eqd_scales, eqd_scales_ds, etc.
...
#
# Examples:
#   ./scp_results.sh -e eqd_scales -t all               # Download to ./EXPERIMENT/eqd_scales/
#   ./scp_results.sh -e eqd_scales_ds -t logs           # Download logs to ./EXPERIMENT/eqd_scales_ds/
#   ./scp_results.sh -e eqd_scales_ds -t all -p ./results
# =============================================================================
...
while getopts "e:t:p:h" opt; do
    case $opt in
        ...
        h)
            ...
            echo ""
            echo "Options:"
            echo "  -e  Experiment name (required): eqd_scales, eqd_scales_ds, etc."
            ...
            echo ""
            echo "Examples:"
            echo "  $0 -e eqd_scales -t all"
            echo "  $0 -e eqd_scales_ds -t logs"
            echo "  $0 -e eqd_scales_ds -t checkpoints"
            exit 0
            ;;
        \?)
