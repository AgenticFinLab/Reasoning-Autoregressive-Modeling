#!/bin/bash
# =============================================================================
# SCP Script: Download EQD Scales Experiment Results to Local Machine
# =============================================================================
...
#
# Examples:
#   ./scp_results.sh eqd_scales        # Download training results
#   ./scp_results.sh eqd_scales_ds     # Download DeepSpeed results
...
case $EXPERIMENT in
    eqd_scales)
        download_all "eqd_scales"
        ;;
    eqd_scales_ds)
        download_all "eqd_scales_ds"
        ;;
    all)
        download_all "eqd_scales"
        download_all "eqd_scales_ds"
    ...
    *)
        ...
        echo "Usage: $0 [eqd_scales|eqd_scales_ds|all]"
        exit 1
        ;;
esac
