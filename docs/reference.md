...
- ∇-REASONER: LLM REASONING VIA TEST-TIME
GRADIENT DESCENT IN LATENT SPACE

- NATIVE REASONING MODELS: TRAINING LANGUAGE
MODELS TO REASON ON UNVERIFIABLE DATA ∗

- Latent Thoughts Tuning: Bridging Context and Reasoning
